...
--       ao fim e criou tudo sem erro. Os testes do 09 passaram, com UM limite
--       conhecido: só a policy de SELECT foi exercitada. INSERT/UPDATE/DELETE
--       como `authenticated` seguem sem teste. Branch destruída.
